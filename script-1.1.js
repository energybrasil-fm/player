        import { stations } from './estacoes-1.1.js';
...
const homeStationsBtn = document.getElementById('homeStationsBtn');
...
if(homeStationsBtn) homeStationsBtn.addEventListener('click', openStationsAction);
