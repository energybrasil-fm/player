import { stations } from './estacoes-2.8.js';
...
function initVisualizer() {
    if (!audioCtx) {
        ...
        try {
            ...
            zBass.type = 'lowshelf';
            zBass.frequency.value = 65; 
            zBass.gain.value = 2.0; 
            
            const zTreble = audioCtx.createBiquadFilter();
            zTreble.type = 'highshelf';
            zTreble.frequency.value = 9500;
            zTreble.gain.value = 2.0; 

            const agcNode = audioCtx.createDynamicsCompressor();
            agcNode.threshold.value = -18; 
            agcNode.knee.value = 20; 
            agcNode.ratio.value = 2.5; 
            agcNode.attack.value = 0.05; 
            ...
            finalBrickwall.threshold.value = -1.5; 
            finalBrickwall.knee.value = 0.0; 
            finalBrickwall.ratio.value = 20.0; 
            finalBrickwall.attack.value = 0.001; 
            finalBrickwall.release.value = 0.05; 

            source.connect(zBass);
            zBass.connect(zTreble);
